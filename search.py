...
# Define global variables for search results and current book index
rows = []
current_book_index = -1

def setup_search_tab(tab, role, username):
    global category_combobox, title_entry, author_entry, isbn_entry, book_info_frame, title_value, author_value, isbn_value, stock_value, abstract_text, prev_button, next_button
